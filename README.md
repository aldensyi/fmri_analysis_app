...
### Authors
- [Sangmin Yi](sminyi0130@gmail.com)
...
### Citations
There is not a particular paper published concerning the module from Nilearn and its modules.

However, if you want to cite Nilearn and its related modules:
```json
@software{Nilearn,
